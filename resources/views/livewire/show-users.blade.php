                              ...
                              <tr>
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    ...
                                    @if ($user->role->name == 'admin')
                                        <p class="bg-transparant text-lime-800 font-bold">
                                          <span> {{$user->role->name}} </span>
                                        </p>
                                    @else
                                        <p class="bg-transparant text-emerald-400 font-bold">
                                          <span> {{$user->role->name}} </span>
                                        </p>
                                    @endif
                                    {{-- {{ $user->role->name }} --}}
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                      <a href="#"
                                        ...
                                        <form action="#" class="inline" method="post" onsubmit="return confirm('Yakin untuk menghapus {{$user->name}}?'); ">
                                          @csrf
                                          @method('delete')
                                          <button type="submit"
