...
class Member extends Component
{
    ...
    {
        $this->members = ModelsMember::orderBy('created_at', 'DESC')->get(); //MEMBUAT QUERY UNTUK MENGAMBIL DATA
        return view('livewire.member'); //LOAD VIEW MEMBERS.BLADE.PHP YG ADA DI DALAM FOLDER /RESOURSCES/VIEWS/LIVEWIRE
    }
    ...
    public function store()
    {
        ...
        ModelsMember::updateOrCreate(['id' => $this->member_id], [
            'name' => $this->name,
            'email' => $this->email,
    ...
    {
        $member = ModelsMember::find($id); //BUAT QUERY UTK PENGAMBILAN DATA
    ...
    {
        $member = ModelsMember::find($id); //BUAT QUERY UNTUK MENGAMBIL DATA BERDASARKAN ID
